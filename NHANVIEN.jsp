...
<report name="NHANVIEN" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL NHANVIEN.MANHANVIEN, NHANVIEN.TENNHANVIEN, NHANVIEN.SODIENTHOAI
FROM NHANVIEN ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_MANHANVIEN">
        <displayInfo x="1.26746" y="1.94995" width="1.46521" height="0.79956"
        />
        <dataItem name="MANHANVIEN" datatype="vchar2" columnOrder="11"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Manhanvien">
          <dataDescriptor expression="NHANVIEN.MANHANVIEN"
           descriptiveExpression="MANHANVIEN" order="1" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TENNHANVIEN" datatype="vchar2" columnOrder="12"
         width="50" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Tennhanvien">
          <dataDescriptor expression="NHANVIEN.TENNHANVIEN"
           descriptiveExpression="TENNHANVIEN" order="2" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SODIENTHOAI" datatype="vchar2" columnOrder="13"
         width="15" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Sodienthoai">
          <dataDescriptor expression="NHANVIEN.SODIENTHOAI"
           descriptiveExpression="SODIENTHOAI" order="3" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
      ...
      <frame name="M_G_MANHANVIEN_GRPFR">
        ...
        <repeatingFrame name="R_G_MANHANVIEN" source="G_MANHANVIEN"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_MANHANVIEN" source="MANHANVIEN" minWidowLines="1"
          ...
          <field name="F_TENNHANVIEN" source="TENNHANVIEN" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
          ...
          <field name="F_SODIENTHOAI" source="SODIENTHOAI" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
        ...
        <frame name="M_G_MANHANVIEN_HDR">
          ...
          <text name="B_MANHANVIEN" minWidowLines="1">
          ...
          <text name="B_TENNHANVIEN" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_SODIENTHOAI" minWidowLines="1">
            <textSettings spacing="0"/>
...
<rw:dataArea id="MGMANHANVIENGRPFR35">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBMANHANVIEN35" asArray="no"/> class="OraColumnHeader"> Manhanvien </th>
   <th <rw:id id="HBTENNHANVIEN35" asArray="no"/> class="OraColumnHeader"> Tennhanvien </th>
   <th <rw:id id="HBSODIENTHOAI35" asArray="no"/> class="OraColumnHeader"> Sodienthoai </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGMANHANVIEN351" src="G_MANHANVIEN">
   <tr>
    <td <rw:headers id="HFMANHANVIEN35" src="HBMANHANVIEN35"/> class="OraCellText"><rw:field id="FMANHANVIEN35" src="MANHANVIEN" nullValue="&nbsp;"> F_MANHANVIEN </rw:field></td>
    <td <rw:headers id="HFTENNHANVIEN35" src="HBTENNHANVIEN35"/> class="OraCellText"><rw:field id="FTENNHANVIEN35" src="TENNHANVIEN" nullValue="&nbsp;"> F_TENNHANVIEN </rw:field></td>
    <td <rw:headers id="HFSODIENTHOAI35" src="HBSODIENTHOAI35"/> class="OraCellText"><rw:field id="FSODIENTHOAI35" src="SODIENTHOAI" nullValue="&nbsp;"> F_SODIENTHOAI </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
